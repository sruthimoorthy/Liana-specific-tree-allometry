...
pc_folder <- "/Users/sruthikp/Work/Analysis/BCI2019/2019_TLS_data/MergedPointclouds/Downsampled_4cm/"
...
write.csv(results, file = "/Users/sruthikp/Work/Analysis/BCI2019/2019_TLS_data/ITSMe_tree_metrics_summary.csv", row.names = FALSE)
